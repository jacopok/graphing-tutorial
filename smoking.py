...
plt.savefig('cigarettes_cancer_v1a.pdf', format = 'pdf', bbox_inches='tight')
...
plt.savefig('cigarettes_cancer_v1b.pdf', format = 'pdf', bbox_inches='tight')
...
fig.savefig('cigarettes_cancer_v2.pdf', format = 'pdf', bbox_inches='tight')
